  ...
  <Layout>
    <div style={style}>
      ...
      <section style={textStyle}>
        ...
        <p>If you'd like to learn more about my work or start a conversation, send me a message at <a href="mailto:elizabethydesign@gmail.com?Subject=Hello" target="_top">elizabethydesign@gmail.com</a>, or visit me at <a href="https://dribbble.com/ElizabethY" target="_blank">https://dribbble.com/ElizabethY</a>. </p>
      </section>
    </div>
  </Layout>
)
